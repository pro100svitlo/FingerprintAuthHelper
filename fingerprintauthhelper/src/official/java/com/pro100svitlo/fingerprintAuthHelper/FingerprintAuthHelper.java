...
public class FingerprintAuthHelper {
    ...
    public static class Builder {
        ...
        public final static long DEF_TRY_TIME_OUT = 45 * 1000;
        private long mTimeOut = 45 * 1000;
...
//        private int mMaxTryCount = 5;
        ...
        public Builder setTryTimeOut(long milliseconds) {
            if (milliseconds < DEF_TRY_TIME_OUT) {
                throw new IllegalArgumentException("tryTimeout must be more than " + DEF_TRY_TIME_OUT + " milliseconds!");
            }
...
//    private int mTryCountLeft;
    ...
    private boolean mIsTimeOutCleaned = false;
